...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-aeat_111',
    download_url='https://github.com:nantic/trytond-aeat_111.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-aeat_111.git'
    },
    classifiers=[
